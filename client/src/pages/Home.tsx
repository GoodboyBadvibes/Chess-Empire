...
export default function Home() {
  ...
  // Hero Image: Chess piece in dramatic lighting
  // https://images.unsplash.com/photo-1586165368502-1bad197a6461?q=80&w=2658&auto=format&fit=crop
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 text-center text-white space-y-8">
          ...
          >
            BIGGER THAN<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-white/50">CHESS.</span>
          </motion.h1>
          ...
          >
            We are building the world's most significant chess company.<br />
      ...
      <Section id="manifesto" className="bg-background">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-12">
          <span className="inline-block text-xs font-bold tracking-[0.3em] uppercase text-accent">The Vision</span>
          <h2 className="font-display text-4xl md:text-6xl leading-tight">
            Chess is not just a game. <br/>
            It is a language of <span className="font-serif-italic text-accent">intellect</span> and <span className="font-serif-italic text-accent">war</span>.
          </h2>
          <div className="prose prose-lg md:prose-xl mx-auto text-muted-foreground font-light leading-relaxed">
            <p>
              We believe the chess world has been stagnant for too long. We are here to disrupt it with luxury, 
              storytelling, and technology. We're creating an ecosystem that bridges the gap between the grandmaster and the artist, 
              the player and the collector.
            </p>
            <p>
              This isn't about selling boards. It's about selling a legacy.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section id="ecosystem" className="bg-primary text-primary-foreground py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-white/10 pb-8">
            <div>
              <span className="block text-xs font-bold tracking-[0.3em] uppercase text-accent mb-4">The Ecosystem</span>
              <h2 className="font-display text-4xl md:text-5xl">Artifacts of Power</h2>
            </div>
            <p className="font-serif-italic text-white/60 text-right mt-4 md:mt-0 max-w-sm">
              Luxury boards, curated merchandise, and digital experiences designed for the modern strategist.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products?.map((product, idx) => (
              ...
              >
                ...
                <h3 className="text-2xl font-display group-hover:text-accent transition-colors">{product.name}</h3>
                <p className="text-white/50 mt-2 font-light">{product.category}</p>
              </motion.div>
            ))}
            
            {!products?.length && (
              <div className="col-span-full py-20 text-center border border-white/10">
                <p className="text-white/30 font-display text-xl uppercase tracking-widest">Collection launching soon</p>
              </div>
            )}
          </div>
        </div>
      ...
      <Section id="stories" className="bg-muted/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <span className="block text-xs font-bold tracking-[0.3em] uppercase text-accent mb-4">The Human Element</span>
            <h2 className="font-display text-4xl md:text-6xl text-primary">Deeply Human Stories</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24">
            {stories?.map((story, idx) => (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <Button variant="link" className="p-0 h-auto text-primary hover:text-accent group uppercase tracking-widest text-sm font-bold mt-4">
            ...
            {!stories?.length && (
              <div className="col-span-full text-center py-20">
                <p className="text-muted-foreground italic">Stories are being written...</p>
              </div>
            )}
          </div>
        </div>
      ...
      {/* === JOIN US (CAREERS) === */}
      <Section id="careers" className="bg-primary text-primary-foreground min-h-[80vh] flex items-center">
        <div className="max-w-5xl mx-auto px-6 w-full">
          <div className="mb-16">
            <span className="block text-xs font-bold tracking-[0.3em] uppercase text-accent mb-4">Join the Team</span>
            <h2 className="font-display text-5xl md:text-7xl mb-6">Build the Legacy</h2>
            <p className="text-xl text-white/60 max-w-2xl font-light">
              We are looking for high-agency, emotionally grounded, and exceptionally smart individuals to shape this vision.
            </p>
          </div>
      ...
      <footer className="bg-black text-white py-12 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <span className="font-display text-2xl tracking-tighter">BIGGER THAN CHESS.</span>
